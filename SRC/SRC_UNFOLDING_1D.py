...
#######################################################################################################
def main_unfold_1D_greedy_new(dPHI_meas, dPHI, S, G_matrix, group, N, output_dir, case_name, x):
    dPHI_reshaped = np.reshape(dPHI, (group, N))
    S_reshaped = np.reshape(S, (group, N))
...
##### 08. GREEDY
    ...
    if valid_solutions_reduced_GREEDY:
        ...
        for g in range(group):
            ...
            plt.xlabel('Distance from core centre [cm]')
            plt.grid()
            plt.savefig(f'{output_dir}/{case_name}_08_GREEDY_NEW/{case_name}_dPHI_GREEDY_magnitude_G{g+1}.png')
            plt.close()
        ...
        for g in range(group):
            ...
            plt.xlabel('Distance from core centre [cm]')
            plt.grid()
            plt.savefig(f'{output_dir}/{case_name}_08_GREEDY_NEW/{case_name}_dPHI_GREEDY_phase_G{g+1}.png')
            plt.close()
        ...
        for g in range(group):
            ...
            plt.xlabel('Distance from core centre [cm]')
            plt.grid()
            plt.savefig(f'{output_dir}/{case_name}_08_GREEDY_NEW/{case_name}_dPHI_GREEDY_real_G{g+1}.png')
            plt.close()
        ...
        for g in range(group):
            ...
            plt.xlabel('Distance from core centre [cm]')
            plt.grid()
            plt.savefig(f'{output_dir}/{case_name}_08_GREEDY_NEW/{case_name}_dS_GREEDY_magnitude_G{g+1}.png')
            plt.close()
